...
| --- | --- | --- |
| [`CAMS-Use-Case-Diagram.drawio`](CAMS-Use-Case-Diagram.drawio) | UML use case | 41 module boxes, 204 use cases, 3 actors, one page |
